...
### 10.1 벤치마크 결과 (Linux x64, 10K 메시지)

**소켓 패턴별 처리량 (64B 메시지)**:

| 패턴 | TCP | IPC | inproc | IPC vs TCP |
|------|-----|-----|--------|------------|
| DEALER↔DEALER | 2.90 M/s | **4.91 M/s** | 4.34 M/s | **+69%** |
| PAIR | 2.95 M/s | **4.78 M/s** | 4.60 M/s | **+62%** |
| DEALER↔ROUTER | 2.51 M/s | **4.56 M/s** | 4.08 M/s | **+81%** |
| PUB/SUB | 2.91 M/s | **4.55 M/s** | 4.01 M/s | **+56%** |
| ROUTER↔ROUTER | 2.25 M/s | **3.65 M/s** | 3.54 M/s | **+62%** |
...
| 메시지 크기 | WS | WSS | TCP (참조) |
|------------|-----|-----|------------|
| 64B | 2,805 K/s | 2,525 K/s | 2,900 K/s |
| 1KB | 696 K/s | 530 K/s | 1,493 K/s |
| 64KB | 23 K/s | 12 K/s | - |
