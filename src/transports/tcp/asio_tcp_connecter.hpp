...
#ifndef __ZMQ_ASIO_TCP_CONNECTER_HPP_INCLUDED__
#define __ZMQ_ASIO_TCP_CONNECTER_HPP_INCLUDED__
...
class asio_tcp_connecter_t ZMQ_FINAL : public own_t, public io_object_t
{
  public:
    ...
    asio_tcp_connecter_t (zmq::io_thread_t *io_thread_,
  ...
  private:
    ...
    ZMQ_NON_COPYABLE_NOR_MOVABLE (asio_tcp_connecter_t)
};
}  // namespace zmq

#endif  // ZMQ_IOTHREAD_POLLER_USE_ASIO

#endif  // __ZMQ_ASIO_TCP_CONNECTER_HPP_INCLUDED__
